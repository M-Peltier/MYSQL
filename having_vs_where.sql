...
where occupation like "%manager%" -- filter at the row level in the where clause
group by occupation 
having avg(salary) > 75000 
-- filter at the aggregate function level
-- HAVING is only going to work after the group by aggregate function
-- if you want to filter on the aggregate functions you must use HAVING clause
;